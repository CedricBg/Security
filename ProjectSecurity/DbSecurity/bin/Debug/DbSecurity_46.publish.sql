...
GO
PRINT N'Création de Clé étrangère [dbo].[FK_USERS_EM]...';


GO
ALTER TABLE [dbo].[Employee]
    ADD CONSTRAINT [FK_USERS_EM] FOREIGN KEY ([IdUsers]) REFERENCES [dbo].[Users] ([IdUser]);
...
INSERT INTO Users (Login,Salt, Password_hash) Values('Cedric', 'sdfsdfgffgdfgdfsgsdfgtt', 'ujgyd54sd54sdfsd5f')
