...
Set NOCOUNT ON
	...
	Insert into Customer ([Name], GeneralPhone, EmergencyPhone,EmergencyEmail,IdInformation, IdLanguages) 
	values(@Name, @GeneralPhone, @EmergencyPhone,@EmergencyEmail,@info, @IdLanguage) 
