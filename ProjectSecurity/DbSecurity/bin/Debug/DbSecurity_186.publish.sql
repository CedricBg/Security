...
begin
	...
	c.Country
		...
		AND C.IdCountrys = info.IdCountry
		and cust.IdLanguage = E.IdLanguage
End
GO
...
Begin
	...
	Select C.[Name], C.IdLanguage, C.IdCustomer, U.[Login] 
...
ALTER TABLE Customer ADD CONSTRAINT FK_CUST_STATUT FOREIGN KEY (IdStatut) REFERENCES StatutAgent (IdStatut)
ALTER TABLE Customer ADD CONSTRAINT FK_CUST_LANG FOREIGN KEY (IdLanguage) REFERENCES Employee_Language (IdLanguage)
...
INSERT INTO Customer([Name], GeneralPhone,EmergencyPhone, EmergencyEmail, IdInformation, IdLanguage, IdStatut) Values ('Danone','0455555555','101','emerg@email.com', 1, 1,21)
