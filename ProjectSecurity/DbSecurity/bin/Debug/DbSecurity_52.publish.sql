...
End
GO
PRINT N'Création de Par défaut [dbo].[alter]...';


GO
CREATE DEFAULT [dbo].[alter]
    AS 'Unknown';
...
--------------------------------------------------------------------------------------
*/
Alter Table employee ADD CONSTRAINT FK_USERS_EM FOREIGN KEY (IdUsers) REFERENCES Users (IdUser) On Delete Cascade
...
Alter Table employee ADD CONSTRAINT FK_STATUT_EMPLOYEE FOREIGN KEY ([IdStatut]) REFERENCES StatutAgent (IdStatut) 
