...
GO
PRINT N'L''opération suivante a été générée à partir d''un fichier journal de refactorisation 298a506f-332e-4466-ba8d-22b79aa9f55b, 3118fd6f-fec5-42ae-8780-253194c4c0cd';

PRINT N'Renommer [dbo].[Grade].[IdGrade] en IdGrades';


GO
EXECUTE sp_rename @objname = N'[dbo].[Grade].[IdGrade]', @newname = N'IdGrades', @objtype = N'COLUMN';
