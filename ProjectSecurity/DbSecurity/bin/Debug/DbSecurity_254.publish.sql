...
GO
PRINT N'Création de Table [dbo].[AddCheckRfid]...';
...
CREATE TABLE [dbo].[AddCheckRfid] (
    ...
    PRIMARY KEY CLUSTERED ([IdCheck] ASC)
);
...
CREATE TABLE [dbo].[RfidPatrol] (
    [IDRfid]     INT           IDENTITY (1, 1) NOT NULL,
...
CREATE TABLE [dbo].[Ronde] (
    [IdRonde]    INT          IDENTITY (1, 1) NOT NULL,
    [IdCustomer] INT          NOT NULL,
...
GO
PRINT N'Création de Table [dbo].[TimeRonde]...';
...
GO
PRINT N'Création de Contrainte par défaut contrainte sans nom sur [dbo].[Customer]...';
...
GO
PRINT N'Création de Déclencheur [dbo].[DeleteCustomers]...';
...
END
GO
PRINT N'Création de Déclencheur [dbo].[DeleteEmployees]...';
...
END
GO
PRINT N'Création de Procédure [dbo].[AddCustomer]...';
...
End
GO
PRINT N'Création de Procédure [dbo].[AddPassage]...';
...
GO
PRINT N'Création de Procédure [dbo].[AddSelectToRonde]...';
...
RETURN 0
GO
PRINT N'Création de Procédure [dbo].[CreateRonde]...';
...
RETURN 0
GO
PRINT N'Création de Procédure [dbo].[CustomerById]...';
...
CREATE PROCEDURE [dbo].[CustomerById]
	...
	End
GO
PRINT N'Création de Procédure [dbo].[DeleteCustomer]...';
...
END
GO
PRINT N'Création de Procédure [dbo].[DeleteEmployee]...';
...
END
GO
PRINT N'Création de Procédure [dbo].[DeleteRonde]...';
...
End
GO
PRINT N'Création de Procédure [dbo].[DepartementOnEmployee]...';
...
End
GO
PRINT N'Création de Procédure [dbo].[EndRonde]...';
...
GO
PRINT N'Création de Procédure [dbo].[EndWork]...';
...
RETURN 0
GO
PRINT N'Création de Procédure [dbo].[GetAll]...';
...
End
GO
PRINT N'Création de Procédure [dbo].[getOneByCustomer]...';
...
GO
PRINT N'Création de Procédure [dbo].[getOneByEmployee]...';
...
END
GO
PRINT N'Création de Procédure [dbo].[GetRonde]...';
...
End
GO
PRINT N'Création de Procédure [dbo].[GetRondeFinish]...';
...
AS
begin
SELECT DISTINCT T.[Start], t.[End], R.NameRonde ,
(SELECT Name from Employee where IdEmployee = T.IdEmployee)as Name , RF.Location, 
(Select Name from Customer where IdCustomer = @Id) as Client
FROM TimeRonde T, AddCheckRfid A,Ronde R,RfidPatrol RF
WHERE R.IdCustomer = @Id
and A.RfidNr = RF.RfidNumber
and R.IdRonde = T.IdRonde
end
GO
PRINT N'Création de Procédure [dbo].[LoginCustomer]...';
...
Begin
	...
	Select E.[Name], E.firstName, E.IdLanguage, S.Classe , E.IdEmployee, U.[Login] 
...
End
GO
PRINT N'Création de Procédure [dbo].[PutCustomer]...';
...
End
GO
PRINT N'Création de Procédure [dbo].[PutEmployee]...';
...
GO
PRINT N'Création de Procédure [dbo].[PutRonde]...';
...
End
GO
PRINT N'Création de Procédure [dbo].[RfidRondes]...';
...
GO
PRINT N'Création de Procédure [dbo].[StartRonde]...';
...
End
GO
PRINT N'Création de Procédure [dbo].[StartWork]...';
...
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '0b7cbd9d-bb34-4514-8d12-1db2525c5a05')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('0b7cbd9d-bb34-4514-8d12-1db2525c5a05')
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '7b604e73-d3d2-4a1c-8221-8394cb1e7706')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('7b604e73-d3d2-4a1c-8221-8394cb1e7706')
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '636f0906-69d3-4e13-a7a1-574dd12c6185')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('636f0906-69d3-4e13-a7a1-574dd12c6185')
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = 'b3d52e00-c3a8-4a89-a00c-a67cdc0acb38')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('b3d52e00-c3a8-4a89-a00c-a67cdc0acb38')
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '1f9482b6-67fd-4197-9314-05aa54382378')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('1f9482b6-67fd-4197-9314-05aa54382378')
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '3cb22bd9-2647-4bc1-97fd-74cc99f1bbf3')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('3cb22bd9-2647-4bc1-97fd-74cc99f1bbf3')
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = 'feeb9a9e-babc-447e-9c92-2153d74c0d25')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('feeb9a9e-babc-447e-9c92-2153d74c0d25')
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = 'dea4592e-9cfe-409c-acbd-0c52be5233d4')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('dea4592e-9cfe-409c-acbd-0c52be5233d4')
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '58cb1297-f1a7-4cf7-ac5f-ab3487d72a6f')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('58cb1297-f1a7-4cf7-ac5f-ab3487d72a6f')
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = 'e5b27b31-5179-4326-8e89-f187f6a577c0')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('e5b27b31-5179-4326-8e89-f187f6a577c0')
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '6158b98a-90d8-4fd9-8fa8-9044c4d01772')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('6158b98a-90d8-4fd9-8fa8-9044c4d01772')
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '62d58734-934a-492d-b7aa-4596aec65143')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('62d58734-934a-492d-b7aa-4596aec65143')
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = 'a96bedf1-017b-4326-9154-9d76d0d9c06c')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('a96bedf1-017b-4326-9154-9d76d0d9c06c')
