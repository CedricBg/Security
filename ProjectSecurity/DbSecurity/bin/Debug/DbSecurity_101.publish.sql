...
CREATE PROCEDURE [dbo].[PutCustomer]
	...
	@IdCustomer int
AS
	Update Customer Set Name = @Name , GeneralPhone = @GeneralPhone, EmergencyEmail = @EmergencyEmail, EmergencyPhone = @EmergencyPhone 
	Where IdCustomer = @IdCustomer
	Update Informations Set Street = @Street, PostCode = @PostCode, StreetNumber=@StreetNumber, Phone = @Phone ,Email = @Email Where IdInformation = @IdInformation
