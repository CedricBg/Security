...
GO
PRINT N'Création de Clé étrangère [dbo].[FK_STATUT_EMPLOYEE]...';


GO
ALTER TABLE [dbo].[Employee]
    ADD CONSTRAINT [FK_STATUT_EMPLOYEE] FOREIGN KEY ([IdStatut]) REFERENCES [dbo].[StatutAgent] ([IdStatut]);
...
INSERT INTO Employee ([Name], firstName, BirthDate, SecurityCardNumber, EntryService, EmployeeCardNumber, RegistreNational,IdStatut, IdLanguage, IdInformation, IdStatut)
Values ('Bogaert','Cédric', '1978/04/01','489513574','2009/09/08','15234576464', '215-58.15-58', 1,1,1,3)
GO
