...
--------------------------------------------------------------------------------------
*/
INSERT INTO StatutAgent (Classe, NomClasse) Values("SB", "Agent statique" )
INSERT INTO StatutAgent (Classe, NomClasse) Values("SQ", "Agent statique qualifié" )
INSERT INTO StatutAgent (Classe, NomClasse) Values("SE", "Agent statique expert" )
INSERT INTO StatutAgent (Classe, NomClasse) Values("SEL", "Agent statique expert langues" )
INSERT INTO StatutAgent (Classe, NomClasse) Values("SBG", "Agent statique bodyguard" )
INSERT INTO StatutAgent (Classe, NomClasse) Values("SMB", "Agent statique base militaire"  )
INSERT INTO StatutAgent (Classe, NomClasse) Values("SMBP", "Portier" )
INSERT INTO StatutAgent (Classe, NomClasse) Values("MBB", "Brigadier" )
INSERT INTO StatutAgent (Classe, NomClasse) Values("M1", "Agent mobile patrouille" )
INSERT INTO StatutAgent (Classe, NomClasse) Values("M2", "Agent mobile IAA et chauffeur VIP " )
INSERT INTO StatutAgent (Classe, NomClasse) Values("TR", "Transporteur de fonds/agent ATM" )
INSERT INTO StatutAgent (Classe, NomClasse) Values("PRVA", "Collaborateur vault /processing" )
INSERT INTO StatutAgent (Classe, NomClasse) Values("BI", "Brigadier/instructeur" )
INSERT INTO StatutAgent (Classe, NomClasse) Values("TM", "Transport de munitions" )
INSERT INTO StatutAgent (Classe, NomClasse) Values("G", "Homme de métier" )
INSERT INTO StatutAgent (Classe, NomClasse) Values("DIR", "Direction" )
INSERT INTO StatutAgent (Classe, NomClasse) Values("OP", "Opérations" )
INSERT INTO StatutAgent (Classe, NomClasse) Values("ADM", "Administratif" )
GO
