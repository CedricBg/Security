...
CREATE PROCEDURE [dbo].[CustomerById]
	...
	Begin
		SELECT C.Country
		FROM Customer as cust , Informations as info, Countrys as C 
		Where cust.IdCustomer = @IDCustomer AND info.IdInformation = cust.IdInformation AND C.IdCountrys = info.IdCountry
	End
GO
