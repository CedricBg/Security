...
End
GO
PRINT N'Création de Procédure [dbo].[AddDayWork]...';
...
End
GO
PRINT N'Création de Procédure [dbo].[GetByCustomer]...';
...
Begin
	...
	Update Informations Set Street = @Street, PostCode = @PostCode, StreetNumber = @StreetNumber, Phone = @Phone ,Email = @Email , IdCountry = (select IdCountrys from Countrys where IdCountry = @Country)
...
GO
PRINT N'Création de Procédure [dbo].[PutPlanning]...';
