...
AS
begin
	SELECT * from Start_end_Time where IdCustomer = @Customer
	end
GO
...
AS
begin
	SELECT * from Start_end_Time where IdEmployee = @Employee
	end
GO
...
INSERT INTO ScheduleGuard (StartTime, EndTime, IdEmployee, IdCustomer) Values(19/02/2022, 55/02/1956, 1,1)

INSERT INTO Users ([Login],Salt,Password_hash) Values('ced','EE0B81A4-A225-46AD-95C8-F34CCEBF6F8E2CF0550E-A7B7-4462-B52F-64AB753F884C7F50B6E2-5A0B-401C-9E1E-A51F','0x09F37E6A6CD09E768F4A041A7B9E75951B84C3C892AC60BE6854D38E8341C935145103A2155958531D5DD503D4BC7631FC6E2726A38202DC55E6F332501CAF41')
